        ...
        <div className="container">
          <div className="row my-3">
            ...
            <ul className="footer__list col-lg-4">
              <li className="footer__item"><a href="" class="footer__link"><i class="fab fa-facebook-f"></i></a></li>
              <li className="footer__item"><a href="" class="footer__link"><i class="fab fa-google-plus-g"></i></a></li>
              <li className="footer__item"><a href="" class="footer__link"><i class="fab fa-linkedin-in"></i></a></li>
            </ul>
          </div>
        </div>
      </div>
